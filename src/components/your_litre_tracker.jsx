...
const Litre_Tracker=()=>{
    return(
        <div className="w-full lg:h-[660px] flex xs:flex-col lg:flex-row xs:items-center lg:items-start xs:justify-center lg:justify-between xs:mt-[60px] md:mt-0 md:py-[100px] md:px-[32px] lg:pl-[120px] lg:pt-[55px] lg:pr-[120px] lg:pb-[55px]  gap-0">
            ...
            <p className="md:translate-x-[40px] lg:translate-x-0 tracking-[0.94px] xs:w-[315px] md:w-[90%] lg:w-[92%] text-text_color text-[21px] leading-[31.5px] xs:text-center lg:text-left xs:mb-[30px] md:mb-0 xs:mx-auto md:mx-0">Streamlining Gas Station Management: Your Comprehensive Solution for Tracking, Monitoring, and Streamlining Daily Operations with Precision and Ease.</p>
